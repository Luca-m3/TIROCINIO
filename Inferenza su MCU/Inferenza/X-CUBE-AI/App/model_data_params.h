...
#define AI_MODEL_DATA_ACTIVATIONS_SIZES \
  { 28440, }
#define AI_MODEL_DATA_ACTIVATIONS_SIZE     (28440)
#define AI_MODEL_DATA_ACTIVATIONS_COUNT    (1)
#define AI_MODEL_DATA_ACTIVATION_1_SIZE    (28440)



#define AI_MODEL_DATA_WEIGHTS_SIZES \
  { 1044556, }
#define AI_MODEL_DATA_WEIGHTS_SIZE         (1044556)
#define AI_MODEL_DATA_WEIGHTS_COUNT        (1)
#define AI_MODEL_DATA_WEIGHT_1_SIZE        (1044556)
